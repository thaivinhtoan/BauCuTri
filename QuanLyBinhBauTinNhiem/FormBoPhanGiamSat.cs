...
{
    public partial class FormBoPhanGiamSat : Form
    {
        ThanhVien thanhVien;
        public FormBoPhanGiamSat(ThanhVien tv)
        {
            InitializeComponent();
            thanhVien = tv;
        }
        ...
        private void btXemDSUngVien_Click(object sender, EventArgs e)
        {
            this.Hide();
            var f = new FormXemDSUngVien(thanhVien);
            f.ShowDialog();
            this.Show();
        }
    }
